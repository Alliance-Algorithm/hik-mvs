...
echo "     LD_LIBRARY_PATH=squashfs-root/mvs-gui/bin:squashfs-root/mvs-usb3-core/lib/$ARCH_DIR:squashfs-root/mvs-usb3-core/lib/$ARCH_DIR/ThirdParty ldd squashfs-root/mvs-gui/bin/MVS | grep 'not found'"
